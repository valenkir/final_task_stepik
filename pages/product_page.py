...
class ProductPage(BasePage):
    ...
    def should_be_corresponding_product_name(self, product_name):
        ...
        assert product_name_in_success_message == product_name, ("Product name in the card is not equal to the "
    ...
    def should_be_corresponding_product_price(self, product_price):
        ...
        assert product_price_in_success_message == product_price, ("Product name in the card is not equal to the "
