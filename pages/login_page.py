...
class LoginPage(BasePage):
    def register_new_user(self, email, password):
        e_mail_field = self.driver.find_element(*LoginPageLocators.REGISTRATION_EMAIL_FIELD)
        password_field = self.driver.find_element(*LoginPageLocators.REGISTRATION_PASSWORD_FIELD)
        confirm_password_field = self.driver.find_element(*LoginPageLocators.REGISTRATION_CONFIRM_PASSWORD_FIELD)
